...
while True:
    ...
    if current_mode == "main":
        ...
        if active_field == "x":
            draw_text((-24, 20.0, 0), "The X coordinate: " + x_input + "_", (255, 255, 255))
        else:
            draw_text((-24, 20.0, 0), "The X coordinate: " + x_input, (255, 255, 255))
        if active_field == "y":
            draw_text((-24.5, 17, 0), "The Y coordinate: " + y_input + "_", (255, 255, 255))
        else:
            draw_text((-24.5, 17, 0), "The Y coordinate: " + y_input, (255, 255, 255))
        if active_field == "z":
            draw_text((-25, 14.0, 0), "The Z coordinate: " + z_input + "_", (255, 255, 255))
        else:
            draw_text((-25, 14.0, 0), "The Z coordinate: " + z_input, (255, 255, 255))
        if active_field == "chunk_size":
            draw_text((-25.5, 11.0, 0), "The size of the chunk: " + chunk_size_input + "_", (255, 255, 255))
        else:
            draw_text((-25.5, 11.0, 0), "The size of the chunk: " + str(chunk_size), (255, 255, 255))
        if active_field == "seed":
            draw_text((-26, 8.0, 0), "Change the seed of the world: " + seed_input + "_", (255, 255, 255))
        else:
            draw_text((-26, 8.0, 0), "Change the seed of the world: " + seed_input, (255, 255, 255))
        if active_field == "single_base":
            draw_text((-26.5, 5.0, 0), "A single 'base' of the world (yes/no): " + single_base_input + "_", (255, 255, 255))
        else:
            draw_text((-26.5, 5.0, 0), "A single 'base' of the world (yes/no): " + single_base_input, (255, 255, 255))
        ...
        # Отрисовка сид мира
        draw_text((-23.5, 23.0, 0), "Seed of the world: " + str(seed), (255, 255, 255))
